...
| 고객 상담 | 내 바인더 | /personal-binders | /customer-consulting/personal-binders | BinderListScreen / BinderEditorScreen / BinderViewerScreen | GET/POST/PATCH/DELETE /api/personal-binders, materials, sections, items, GET export PDF | NATIVE | NATIVE | 프로덕션 404는 빈 안내. 자료 삭제 409는 서버 문구. WebView 없음 |
